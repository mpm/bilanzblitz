...
puts "Note: Using new implementation. Run 'ruby contrib/skr03_mapping/bin/skr03_mapper generate-mapping' directly."
puts

command = Contrib::SKR03Mapping::Commands::GenerateMapping.new
command.execute
